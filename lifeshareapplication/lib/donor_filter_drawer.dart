// donor_filter_drawer.dart
import 'package:flutter/material.dart';
import 'package:lifeshareapplication/tabbar.dart';
import 'package:shared_preferences/shared_preferences.dart';

class DonorFilterDrawer extends StatefulWidget {
  final void Function(String?, String?) onFilterChanged;

  const DonorFilterDrawer({super.key, required this.onFilterChanged});

  @override
  State<DonorFilterDrawer> createState() => _DonorFilterDrawerState();
}
...
class _DonorFilterDrawerState extends State<DonorFilterDrawer> {
  ...
  Future<void> loadPreferences() async {
    ...
    setState(() {
      selectedBloodGroup = _prefs.getString('selectedBloodGroup');
      selectedOrganType = _prefs.getString('selectedOrganType');
    });
  }

  void _savePreferences() async {
    await _prefs.setString('selectedBloodGroup', selectedBloodGroup ?? '');
    await _prefs.setString('selectedOrganType', selectedOrganType ?? '');
  }
